...
MutableTextSprite::MutableTextSprite(const UnsignedInt capacity, Text::Alignment alignment, Object2D* parent, SceneGraph::DrawableGroup2D* drawables): Object2D(parent), SceneGraph::Drawable2D(*this, drawables), _backgroundColor(Color3(0.6f)), _color(Color3(0.0f)) {
    ...
    _renderer.reset(new Text::Renderer2D(*_font, *_glyphCache, 6.0f, alignment));
